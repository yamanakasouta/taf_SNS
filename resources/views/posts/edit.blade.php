                ...
                <div class="p-6 text-gray-900">
                    <div class="w-full">
                        <form method="post" action="{{route('posts.store',['id' => $practices->id])}}" class="px-8 pt-6 pb-8 mb-3">
                            ...
                            {{-- 登録ボタン --}}
                            <button class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 focus:outline-none">保存</button>
                        </form>
                    </div>
                </div>
            </div>
